...
<script>
import template from '../../../markdown/examples/template/weekview/short-interval-label.md'
import script from '../../../markdown/examples/script/weekview/short-interval-label.md'
