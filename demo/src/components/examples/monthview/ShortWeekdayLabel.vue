...
<script>
import template from '../../../markdown/examples/template/monthview/short-weekday-label.md'
import script from '../../../markdown/examples/script/monthview/short-weekday-label.md'
