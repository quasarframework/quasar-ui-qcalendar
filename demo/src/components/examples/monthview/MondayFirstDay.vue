...
<script>
import template from '../../../markdown/examples/template/monthview/monday-first-day.md'
import script from '../../../markdown/examples/script/monthview/monday-first-day.md'
