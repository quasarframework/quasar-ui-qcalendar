<template>
  <div>
    ...
    <example-viewer
      title="Disabled Days"
      file="SchedulerViewDisabledDays"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="SchedulerViewDisabledBeforeAfter"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="SchedulerViewDisabledWeekdays"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="SchedulerViewResourceWidthHeight"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="SchedulerViewCustomHeight"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Slot (scheduler-resources-header)"
      file="SchedulerViewSlotResourcesHeader"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Slot (scheduler-day-header)"
      file="SchedulerViewSlotDayHeader"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Slot (scheduler-resource-day)"
      file="SchedulerViewSlotResourceDay"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Slot (scheduler-resource)"
      file="SchedulerViewSlotResource"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Cell Width + Sticky"
      file="SchedulerViewCellWidth"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
