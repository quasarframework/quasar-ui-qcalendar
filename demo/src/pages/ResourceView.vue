<template>
  <div>
    ...
    <example-viewer
      title="Interval Header Width/Height"
      file="ResourceViewIntervalHeaderWidthHeight"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="ResourceViewIntervalCount"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="ResourceViewIntervalMinutes30"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="ResourceViewIntervalMinutes15"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="ResourceViewIntervalStart"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="ResourceViewResourceWidthHeight"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Custom Resource Height"
      file="ResourceViewCustomHeight"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="resource-interval Slot"
      file="ResourceViewSlots"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="resource-header Slot"
      file="ResourceViewSlotResourceHeader"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="resource-label Slot"
      file="ResourceViewSlotResourceLabel"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
