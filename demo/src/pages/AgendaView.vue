<template>
  <div>
    ...
    />
    <example-viewer
      title="Agenda View (week) - Basic"
      file="AgendaViewWeekBasic"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="AgendaViewWeekFirstDayMonday"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="AgendaViewWeekFiveDayWorkweek"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="AgendaViewWeekColumnOptions"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
