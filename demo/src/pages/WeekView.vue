<template>
  <div class="q-markdown">
    ...
    <example-card title="Week View - First Day Monday" name="WeekViewMondayFirstDay" :tag-parts="getTagParts(require('!!raw-loader!../examples/WeekViewMondayFirstDay.vue').default)" />
