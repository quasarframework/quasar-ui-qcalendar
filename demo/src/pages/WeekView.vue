<template>
  <div>
    ...
    <example-viewer
      ...
      file="WeekViewShortWeekdayLabel"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Short Interval Label"
      file="WeekViewShortIntervalLabel"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Short Interval Label (Hour24Format)"
      file="WeekViewShortIntervalLabelHour24Format"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="WeekViewDisabledBeforeAfter"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Multi-Interval Selection (range)"
      file="WeekViewSelection"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
