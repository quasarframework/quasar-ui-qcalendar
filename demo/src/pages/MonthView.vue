<template>
  <div>
    ...
    <example-viewer
      ...
      file="MonthViewShortWeekdayLabel"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Show Day of Year Label"
      file="MonthViewShowDayOfYearLabel"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="MonthViewEnableOutsideDays"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="MonthViewDisabledBeforeAfter"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      ...
      file="MonthViewDisabledWeekdays"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
    ...
    <example-viewer
      title="Multi-Day Selection (range)"
      file="MonthViewSelection"
      codepen-title="QCalendar"
      :location-url="locationUrl"
      :js-paths="jsPaths"
      :css-paths="cssPaths"
