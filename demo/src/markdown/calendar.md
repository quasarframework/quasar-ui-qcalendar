...
QCalendar is a powerful calendar component that plugs right into your Quasar application. It allows for both day (1-7 days for a week), monthly and scheduler views. Painstaking care has been given to make almost every aspect of QCalendar configurable and/or modifiable in some way and control given to the developer.
