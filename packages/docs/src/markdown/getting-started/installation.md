...
::: tip
QCalendar v5's app extension targets Quasar CLI Vite projects using `@quasar/app-vite` `>=3.0.0-rc.1`. For non-Quasar Vue/Vite apps, install the UI package directly and skip the app extension.
:::
