...
Use this guide to migrate from QCalendar v4.x to QCalendar v5.0.0-rc.9.
...
| Vue                           | Vue 3                           |
| Quasar                        | Quasar 2                        |
| Quasar CLI                    | `@quasar/app-vite` >=3.0.0-rc.4 |
...
- The extension is compatible with `@quasar/app-vite` `>=3.0.0-rc.4`.
