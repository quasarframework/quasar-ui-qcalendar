...
export type ThemeRecord = Record<string, string>
  ...
  state: () => ({
    ...
    hints: {
      ...
      '--calendar-border-section':
        'Interval borders (borders between regular borders for interval-based calendars)',
      '--calendar-border-section-dark':
        '[DARK] Interval borders (borders between regular borders for interval-based calendars)',

      '--calendar-border-current': 'The border used for `current day`',
      '--calendar-border-current-dark': '[DARK] The border used for `current day`',

      '--calendar-mini-range-connector-hover-border':
        'The border to use beween the two selection days when `hover` property is used. Applicable for `month` calendar with property `mini-mode`',
      '--calendar-mini-range-connector-hover-border-dark':
        '[DARK] The border to use beween the two selection days when `hover` property is used. Applicable for `month` calendar with property `mini-mode`',
      ...
      '--calendar-disabled-date-background-dark':
        '[DARK] The background color of the `disabled` date',
      ...
      '--calendar-mini-selected-color':
        'The text color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-color-dark':
        '[DARK] The text color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-background':
        'The background color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-background-dark':
        '[DARK] The background color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-label-color':
        'The label text color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-label-color-dark':
        '[DARK] The label text color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-label-background':
        'The label background color of a `selected` **date** for `monthly mini-mode`',
      '--calendar-mini-selected-label-background-dark':
        '[DARK] The label background color of a `selected` **date** for `monthly mini-mode`',
      ...
      '--calendar-mini-range-color':
        'The text color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-color-dark':
        '[DARK] The text color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-background':
        'The background color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-background-dark':
        '[DARK] The background color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-label-color':
        'The label text color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-label-color-dark':
        '[DARK] The label text color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-label-background':
        'The label background color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-label-background-dark':
        '[DARK] The label background color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-connector-color':
        'The connector color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-connector-color-dark':
        '[DARK] The connector color of a `selected` **day** for `monthly mini-mode`',
      '--calendar-mini-range-hover-color':
        'The hover color of a `selected` **day** for `monthly mini-mode` when `hover` property is set',
      '--calendar-mini-range-hover-color-dark':
        '[DARK] The hover color of a `selected` **day** for `monthly mini-mode` when `hover` property is set',

      '--calendar-mini-range-firstlast-color':
        'The text color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-color-dark':
        '[DARK] The text color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-background':
        'The background color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-background-dark':
        '[DARK] The background color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-label-color':
        'The label text color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-label-color-dark':
        '[DARK] The label text color of the first and last selected days for `monthly mini-mode`',
      '--calendar-mini-range-firstlast-label-background':
        'The label background color of the first and last selected days for `monthly mini-mode`',
      ...
      '--calendar-mini-work-week-width':
        'The work week width for `month mini-mode`. Use only `px` unit',
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useThemeBuilderStore, import.meta.hot))
}
