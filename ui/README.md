...
- `month-label-size` in QCalendarMonth has additional values added: `xxs` and `xxl`. The values now are as follows: `xxs`='8px', `xs`='10px', `sm`='12px', `md`='14px', `lg`='16px', `xl`='18px' and `xxl`='20px'. As well, you can pass in your own value (ex: '0.75em', '11px', etc)
