<template>
  <div style="margin: 12px;">
    <div style="width: 100%;">This example shows how you can build your own custom navigation bar.</div>
  </div>
  <div
    class="title-bar"
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                style="width: 100%;"
              >{{ monthFormatter(day, true) }}</div>
              <div
                style="width: 100%; font-size: 16px; font-weight: 700;"
              >{{ dayFormatter(day, false) }}</div>
              <div
                style="width: 100%; font-size: 10px;"
              >{{ weekdayFormatter(day, true) }}</div>
            </button>
          </div>
        </div>
      </transition>
